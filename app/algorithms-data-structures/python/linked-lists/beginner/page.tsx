      ...
      <div className="mx-auto w-full max-w-5xl">
        <header className="grid gap-4">
          <p className="text-xs uppercase tracking-[0.4em] text-[color:var(--color-accent-2)]">
            Algorithms - Python - Linked Lists
          </p>
          <h1 className="text-4xl font-semibold text-white font-[var(--font-display)]">
            Linked lists beginner ladder
          </h1>
          <p className="max-w-2xl text-sm leading-6 text-[color:var(--color-muted)]">
            Learn nodes, pointers, and the core rewiring moves that make
            linked list interviews feel intuitive.
          </p>
        </header>

        <div className="mt-10 grid gap-4">
          {linkedListsBeginnerLessons.map((lesson) => (
            <Link
              key={lesson.href}
              href={lesson.href}
