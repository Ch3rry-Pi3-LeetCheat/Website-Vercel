    ...
    <>
      ...
      <div className={title ? "mt-4" : undefined}>
        ...
        {variant === "vector-basic" && (
          <div className="relative">
            <svg viewBox="0 0 700 430" className="h-auto w-full">
              ...
              <text x="88" y="52" textAnchor="end" fill="#f472b6" fontSize="14" fontWeight="700">y</text>
        ...
        {variant === "vector-addition" && (
          <div className="relative">
            <svg viewBox="0 0 700 430" className="h-auto w-full">
              ...
              <text x="118" y="72" textAnchor="end" fill="#f472b6" fontSize="14" fontWeight="700">y</text>
            </svg>
          </div>
        )}
        ...
        {variant === "vector-magnitude" && (
          <div className="relative">
            <svg viewBox="0 48 540 362" className="h-auto w-full">
              ...
              <text x="58" y="82" textAnchor="end" fill="#f472b6" fontSize="14" fontWeight="700">y</text>
        ...
        {variant === "vector-distance" && (
          <div className="relative">
            <svg viewBox="0 0 580 430" className="h-auto w-full">
              ...
              <text x="58" y="32" textAnchor="end" fill="#f472b6" fontSize="14" fontWeight="700">y</text>
        ...
        {variant === "angle-between-vectors" && (
          <div className="relative">
            <svg viewBox="0 0 620 330" className="h-auto w-full">
              <defs>
                {renderFilledArrowMarker("angle-between-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("angle-between-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
              </defs>
              ...
              <g transform="translate(35 0)">
                ...
                <foreignObject x="151" y="208" width="30" height="24">
                  <div className="flex h-full items-center justify-center text-center">
                    <MathInline
                      tex={String.raw`\theta`}
                      className="math-inline math-white text-sm"
          ...
          <div className="relative mx-auto max-w-[560px]">
            <svg viewBox="110 60 280 310" className="h-auto w-full">
              <defs>
                ...
                {renderFilledArrowMarker("angle-example-right-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("angle-example-right-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
              </defs>
          ...
          <div className="relative mx-auto max-w-[560px]">
            <svg viewBox="130 85 255 200" className="h-auto w-full">
              <defs>
                ...
                {renderFilledArrowMarker("angle-example-acute-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("angle-example-acute-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
              </defs>
              ...
              <circle cx="280" cy="190" r="12" fill="none" stroke="rgba(244,114,182,0.26)" strokeWidth="2" />
              <circle cx="230" cy="140" r="7" fill="#22d3ee" />
              <circle cx="230" cy="140" r="12" fill="none" stroke="rgba(34,211,238,0.26)" strokeWidth="2" />
              ...
              <text x="215" y="205" fill="rgba(231,238,248,1)" fontSize="12" fontWeight="700">37°</text>
          ...
          <div className="relative mx-auto max-w-[560px]">
            <svg viewBox="130 90 255 280" className="h-auto w-full">
              <defs>
                ...
                {renderFilledArrowMarker("angle-example-obtuse-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("angle-example-obtuse-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
              </defs>
              ...
              <circle cx="230" cy="140" r="12" fill="none" stroke="rgba(244,114,182,0.26)" strokeWidth="2" />
              <circle cx="230" cy="340" r="7" fill="#22d3ee" />
              <circle cx="230" cy="340" r="12" fill="none" stroke="rgba(34,211,238,0.26)" strokeWidth="2" />
              ...
              <text x="194" y="243" fill="rgba(231,238,248,1)" fontSize="12" fontWeight="700">127°</text>
          ...
          <div className="relative mx-auto max-w-[560px]">
            <svg viewBox="125 70 330 250" className="h-auto w-full">
              <defs>
                ...
                {renderFilledArrowMarker("angle-example-approx-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("angle-example-approx-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
              </defs>
        ...
        {variant === "projection-decomposition" && (
          <div className="relative mx-auto max-w-[560px]">
            <svg viewBox="96 136 428 198" className="h-auto w-full">
              <defs>
                {renderFilledArrowMarker("projection-decomposition-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("projection-decomposition-v-arrow", "rgba(34,211,238,1)", { refX: 5 })}
                {renderFilledArrowMarker("projection-decomposition-proj-arrow", "rgba(231,238,248,1)", { refX: 5 })}
              </defs>
          ...
          <div className="relative mx-auto max-w-[560px]">
            <svg viewBox="56 140 424 206" className="h-auto w-full">
              <defs>
                ...
                {renderFilledArrowMarker("projection-negative-v-arrow", "rgba(34,211,238,1)", { refX: 5 })}
                {renderFilledArrowMarker("projection-negative-proj-arrow", "rgba(231,238,248,1)", { refX: 5 })}
              </defs>
        ...
        {variant === "coordinate-plane-basic" && (
          <div className="relative">
            <svg viewBox="0 0 760 560" className="h-auto w-full">
              ...
              <text x="360" y="36" textAnchor="end" fill="#f472b6" fontSize="14" fontWeight="700">y</text>
            </svg>
        ...
        {variant === "coordinate-plane-movement" && (
          <div className="relative">
            <svg viewBox="0 0 760 520" className="h-auto w-full">
              ...
              <text x="200" y="76" textAnchor="end" fill="#f472b6" fontSize="14" fontWeight="700">y</text>
            </svg>
        ...
        {variant === "linear-combination-basic" && (
          <div className="relative mx-auto w-4/5">
            <svg viewBox="56 52 420 320" className="h-auto w-full">
              ...
              <path d="M110 340 L211 295" stroke="rgba(244,114,182,1)" strokeWidth="2.1" fill="none" markerEnd="url(#linear-combo-basic-u-arrow)" />
              <path d="M110 340 L160 251" stroke="rgba(34,211,238,1)" strokeWidth="2.1" fill="none" markerEnd="url(#linear-combo-basic-v-arrow)" />

              <path d="M218 292 L319 247" stroke="rgba(244,114,182,0.38)" strokeWidth="1.9" strokeDasharray="6 6" fill="none" markerEnd="url(#linear-combo-basic-ghost-u-arrow)" />
              <path d="M329 238 L376 155" stroke="rgba(34,211,238,0.38)" strokeWidth="1.9" strokeDasharray="6 6" fill="none" markerEnd="url(#linear-combo-basic-ghost-v-arrow)" />
              <path d="M110 340 L374 152" stroke="rgba(231,238,248,1)" strokeWidth="2.4" fill="none" markerEnd="url(#linear-combo-basic-result-arrow)" />
          ...
          <div className="relative mx-auto w-4/5">
            <svg viewBox="56 56 420 340" className="h-auto w-full">
              <defs>
                ...
                {renderFilledArrowMarker("linear-combo-family-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("linear-combo-family-a-arrow", "rgba(231,238,248,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("linear-combo-family-b-arrow", "rgba(168,85,247,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("linear-combo-family-c-arrow", "rgba(52,211,153,1)", { refX: 4.35 })}
              </defs>
              ...
              {[1, 2, 3, 4, 5].map((tick) => {
                const x = 130 + tick * 52;
                return renderXAxisTick({
                  key: `linear-combo-family-x-${tick}`,
                  x,
                  axisY: 360,
                  label: tick,
                  labelOffset: 28,
              ...
              <path d="M130 360 L227 319" stroke="rgba(244,114,182,0.88)" strokeWidth="2" fill="none" markerEnd="url(#linear-combo-family-u-arrow)" />
              <path d="M130 360 L178 279" stroke="rgba(34,211,238,0.88)" strokeWidth="2" fill="none" markerEnd="url(#linear-combo-family-v-arrow)" />

              <path d="M130 360 L281 232" stroke="rgba(231,238,248,0.68)" strokeWidth="2.1" fill="none" markerEnd="url(#linear-combo-family-a-arrow)" />
              <path d="M130 360 L385 188" stroke="rgba(168,85,247,0.72)" strokeWidth="2.1" fill="none" markerEnd="url(#linear-combo-family-b-arrow)" />
              <path d="M130 360 L130 235" stroke="rgba(52,211,153,0.72)" strokeWidth="2.1" fill="none" markerEnd="url(#linear-combo-family-c-arrow)" />
        ...
        {variant === "span-one-vector" && (
          <div className="relative mx-auto w-4/5">
            <svg viewBox="0 0 520 340" className="h-auto w-full">
              ...
              <circle cx="320" cy="140" r="13" fill="none" stroke="rgba(244,114,182,0.24)" strokeWidth="2" />

              <text x="332" y="132" fill="#f472b6" fontSize="15" fontWeight="700">u</text>
              <text x="86" y="228" fill="rgba(231,238,248,0.72)" fontSize="12" fontWeight="700">-u</text>
              <text x="418" y="88" fill="rgba(231,238,248,0.72)" fontSize="12" fontWeight="700">2u</text>
              <text x="472" y="206" fill="#22d3ee" fontSize="15" fontWeight="700">x</text>
              <text x="206" y="48" textAnchor="end" fill="#f472b6" fontSize="15" fontWeight="700">y</text>
            </svg>
          </div>
        )}
        ...
        {variant === "span-two-vectors" && (
          <div className="relative mx-auto w-4/5">
            <svg viewBox="0 0 520 340" className="h-auto w-full">
              ...
              <path d="M250 190 L336 147" stroke="rgba(244,114,182,1)" strokeWidth="2.3" fill="none" markerEnd="url(#span-two-u-arrow)" />
              <path d="M250 190 L206 102" stroke="rgba(34,211,238,1)" strokeWidth="2.3" fill="none" markerEnd="url(#span-two-v-arrow)" />
              ...
              <circle cx="342" cy="144" r="13" fill="none" stroke="rgba(244,114,182,0.24)" strokeWidth="2" />
              <circle cx="202" cy="96" r="7.5" fill="#22d3ee" />
              <circle cx="202" cy="96" r="13" fill="none" stroke="rgba(34,211,238,0.24)" strokeWidth="2" />

              <text x="352" y="136" fill="#f472b6" fontSize="15" fontWeight="700">u</text>
              <text x="212" y="88" fill="#22d3ee" fontSize="15" fontWeight="700">v</text>
              <text x="64" y="66" fill="rgba(231,238,248,0.62)" fontSize="12" fontWeight="700">sample combinations</text>
              <text x="472" y="206" fill="#22d3ee" fontSize="15" fontWeight="700">x</text>
              <text x="236" y="40" textAnchor="end" fill="#f472b6" fontSize="15" fontWeight="700">y</text>
            </svg>
          </div>
        )}
        ...
        {variant === "span-dependent-vectors" && (
          <div className="relative mx-auto w-4/5">
            <svg viewBox="0 0 520 340" className="h-auto w-full">
              <defs>
                {renderAxisArrowMarker("span-dep-axis-arrow", "rgba(231,238,248,1)")}
                {renderFilledArrowMarker("span-dep-u-arrow", "rgba(244,114,182,1)", { refX: 4.35 })}
                {renderFilledArrowMarker("span-dep-v-arrow", "rgba(34,211,238,1)", { refX: 4.35 })}
              </defs>

              <line x1="54" y1="190" x2="468" y2="190" stroke="rgba(231,238,248,0.72)" strokeWidth="2" markerEnd="url(#span-dep-axis-arrow)" />
              <line x1="220" y1="294" x2="220" y2="46" stroke="rgba(231,238,248,0.72)" strokeWidth="2" markerEnd="url(#span-dep-axis-arrow)" />

              <line x1="96" y1="252" x2="438" y2="81" stroke="rgba(231,238,248,0.26)" strokeWidth="3" />
              ...
              <circle cx="306" cy="147" r="13" fill="none" stroke="rgba(244,114,182,0.24)" strokeWidth="2" />
              <circle cx="386" cy="107" r="7.5" fill="#22d3ee" />
              <circle cx="386" cy="107" r="13" fill="none" stroke="rgba(34,211,238,0.24)" strokeWidth="2" />

              <circle cx="364" cy="236" r="7" fill="#ffffff" />
              <circle cx="364" cy="236" r="13" fill="none" stroke="rgba(231,238,248,0.18)" strokeWidth="2" />

              <text x="316" y="139" fill="#f472b6" fontSize="15" fontWeight="700">u</text>
              <text x="396" y="99" fill="#22d3ee" fontSize="15" fontWeight="700">v</text>
